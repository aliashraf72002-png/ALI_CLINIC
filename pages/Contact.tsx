    ...
    <div className="pb-24">
      ...
      <section className="bg-gray-50 py-20 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900">{t('contactUsHeader')}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-4">
              ...
              <h3 className="text-xl font-bold">{t('callDirectly')}</h3>
              <p className="text-gray-500 text-sm">{t('forBookings')}</p>
            ...
            <div className="bg-[#228B22] p-8 rounded-[2.5rem] shadow-xl space-y-4 text-white">
              ...
              <h3 className="text-xl font-bold">{t('whatsappUs')}</h3>
              <p className="text-white/80 text-sm">{t('instantSupport')}</p>
              <a
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-bold">{t('ourLocation')}</h4>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-sm border border-gray-100">
              <h3 className="text-3xl font-extrabold text-gray-900 mb-8">{t('sendMessage')}</h3>
              <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={(e) => e.preventDefault()}>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-700">{t('fullName')}</label>
                  <input type="text" className="w-full px-4 py-4 rounded-xl border border-gray-100 bg-gray-50 focus:bg-white focus:border-[#228B22] outline-none transition-all" placeholder={t('johnDoe')} />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-700">{t('emailAddress')}</label>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <input type="text" className="w-full px-4 py-4 rounded-xl border border-gray-100 bg-gray-50 focus:bg-white focus:border-[#228B22] outline-none transition-all" placeholder={t('inquiryExample')} />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-bold text-gray-700">{t('message')}</label>
                  <textarea className="w-full px-4 py-4 rounded-xl border border-gray-100 bg-gray-50 focus:bg-white focus:border-[#228B22] outline-none transition-all h-40" placeholder={t('howCanWeHelp')}></textarea>
                </div>
            ...
            <div className="rounded-[2.5rem] overflow-hidden h-[400px] border-8 border-white shadow-xl bg-gray-100 relative group">
              ...
              <div className="absolute top-6 left-6 bg-white px-6 py-4 rounded-2xl shadow-lg border border-gray-100 pointer-events-none group-hover:scale-105 transition-transform">
                <p className="font-bold text-[#228B22]">Dr. Ali Ashraf Clinic</p>
                <p className="text-xs text-gray-500">{t('clickMap')}</p>
              </div>
            </div>
          </div>
        </div>
