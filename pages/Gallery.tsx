    ...
    <div className="pb-24">
      ...
      <section className="bg-gray-50 py-20 mb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900">{t('visualExperience')}</h1>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {categories.map((cat) => (
            <button
              ...
              className={`px-8 py-3 rounded-full font-bold transition-all ${filter === cat
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                <div className="text-center p-6 translate-y-4 group-hover:translate-y-0 transition-transform">
                  ...
                  <p className="text-white/80 text-sm uppercase tracking-widest">{getTranslatedCategory(item.category)}</p>
